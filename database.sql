...
-- ----------------------------
BEGIN;
INSERT INTO `PostTag` VALUES (25, 1);
...
INSERT INTO `PostTag` VALUES (25, 25);
COMMIT;
...
INSERT INTO `Posts` VALUES (19, 'Lời khuyên về phương pháp giảng dạy trẻ trước khi vào lớp 1', 1, 21, 0, 'Đây là content của bài lời khuyên phương pháp dạy học cho trẻ lớp 1', 'Đây là abstract của phương pháp dạy trẻ lớp 1', '2021-07-06 21:01:47', NULL, 1, 0);
