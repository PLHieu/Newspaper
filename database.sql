...
INSERT INTO `Comments` VALUES (4, NULL, 7, '2021-07-02 00:00:00', 'Alo');
COMMIT;
...
CREATE TABLE `Posts` (
  ...
  FULLTEXT KEY `Abstract` (`Abstract`,`Content`),
...
INSERT INTO `Posts` VALUES (19, 'Test Title', 3, 7, 0, '<p>This is post\'s <strong>CONTENT</strong></p>', 'This is post\'s abstract', '2021-07-04 12:43:55', NULL, 61);
COMMIT;
...
INSERT INTO `Readers` VALUES (4, 'Vuong Nguyen Thi Minh', 'reader_register_self', '$2a$10$4JVJyqn5zOCS0/Nja9ZJ4OxCpcfOEOOfRxP5EQCbqZHWOtGTp40wi', '227 Nguyen Van Cu, District 5,', '2023-01-02', '18120265@student.hcmus.edu.vn', NULL);
INSERT INTO `Readers` VALUES (5, 'Vuong Nguyen Thi Minh', 'hehe', '$2a$10$rpK4eGOvaSyN4yOTzwggA.8Fc9rBisF0pacwTB/EaCKIWL2clqVYO', '227 Nguyen Van Cu, District 5,', '2021-07-22', '18120265@student.hcmus.edu.vn', NULL);
INSERT INTO `Readers` VALUES (6, 'Vuong Nguyen Thi Minh', 'alo', '$2a$10$wOjgU2U7doALMnzRxeBomuNfvIN2uWSi4v8w0eBjKlwL1BXAEjFB6', '227 Nguyen Van Cu, District 5,', '2021-07-16', '18120265@student.hcmus.edu.vn', NULL);
INSERT INTO `Readers` VALUES (7, 'Vuong Nguyen Thi Minh', 'alo1', '$2a$10$unri4FGAKq64V7grAZOcROW.F6GBM/zAPR0j9ncRDytx/ko8211yi', '227 Nguyen Van Cu, District 5,', '2021-06-28', '18120265@student.hcmus.edu.vn', NULL);
INSERT INTO `Readers` VALUES (8, '1', 'abc', '$2a$10$8JLOzYGd3Ia1kB7Azn8qAON4/TPfkyPgd/u/FdDyG15sB1d7CqgBq', '1', '2021-07-01', '11@gmail.com', NULL);
INSERT INTO `Readers` VALUES (9, 'a', 'a', '$2a$10$D7N2A9HxxcSWOoy3j4/bW.9DbfiDA5Cjg7.II1OI34fghlCvUhdE6', 'a', '2021-06-28', 'a@gmail.com', NULL);
INSERT INTO `Readers` VALUES (10, 'a', 'ab', '$2a$10$Y6gM3z9Ui.DnCgnPK7E/sOUshvpv3Gfu8cwr98TxuOYzQlCuViPga', 'a', '2021-06-30', 'a@gmail.com', NULL);
INSERT INTO `Readers` VALUES (11, 'Vuong Nguyen Thi Minh', 'zxc', '$2a$10$ts2tzuY377vxQwav6gLMH.i6OojmK1l9.6vgOXfcjBsH5lWs07pWW', '227 Nguyen Van Cu, District 5,', '2015-11-02', '18120265@student.hcmus.edu.vn', NULL);
COMMIT;
...
INSERT INTO `Writers` VALUES (3, 'Writer 3', 'ABC', 'wrt3', '$2a$10$VmT9wfxpoOAvz9e/kVJCkOvkON1CvhJULiDy5gTfkixFczsHe9xke', 'ABC', NULL, '123@gmail.com');
COMMIT;
